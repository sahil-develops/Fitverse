...
<div>
  ...
  <img src="/greenCircle.svg" alt="" className="absolute -z-[1] -left-[380px] -top-16  lg:flex sm:hidden"  />
  <img src="/blueCircle2.svg" alt="" className="absolute -z-[1] -left-10 -top-10  lg:flex sm:hidden"  />
</div>
        <div className=" mx-auto flex flex-wrap items-center z-10 lg:flex-row sm:flex-col-reverse lg:px-12 px-8  py-14 ">
          ...
          <div className="lg:w-2/6 md:w-1/2  rounded-lg p-8 sm:flex hidden flex-col md:ml-auto w-full mt-10 md:mt-0">
